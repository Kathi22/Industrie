 ...
 */
public class MySubscriptionNotificationListener implements
		SubscriptionNotificationListener {

	@Override
	public void onBufferOverflow(Subscription subscription,
			UnsignedInteger sequenceNumber, ExtensionObject[] notificationData) {
	...
	public long onMissingData(UnsignedInteger lastSequenceNumber,
		...
		// failing Republish
		SampleConsoleClient.println("Data missed: lastSequenceNumber="
	...
	@Override
	public void onStatusChange(Subscription subscription, StatusCode oldStatus,
			StatusCode newStatus, DiagnosticInfo diagnosticInfo) {
